...
<body>
    <div>
        ...
        <div class="theTop col-xs-12 col-sm-8 col-md-7 col-lg-7">
            <p class="name">
        ...
        <div class="container jankStuff">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2" style="margin-left: auto;margin-right: auto; text-align:center;">
